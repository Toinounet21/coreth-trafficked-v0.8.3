...
echo "Building Coreth Mod Coreth Version: $coreth_version; GitCommit: $coreth_commit"
go build -ldflags "-X github.com/Toinounet21/coreth-trafficked-v0.8.3/plugin/evm.GitCommit=$coreth_commit -X github.com/Toinounet21/coreth-trafficked-v0.8.3/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go